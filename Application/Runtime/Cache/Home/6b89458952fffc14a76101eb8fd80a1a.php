...
<div class="minNav">
    <div class="navInner">
        ...
        <!--</span>-->
        <span class="login" style="display:block;" id="ks110_LoginStatus">
            <strong><span id="ks110_CurrentUser"></span></strong><?php echo ($name); ?>，您好。欢迎来到在线考试(kaoshi.com)
            <a id="ks110_LoginOut" href="/thinkphp/home/login/login_out" rel="nofollow">[点此退出]</a>
        </span>
    </div>
</div>
<!--顶部登录/注册 结束-->
