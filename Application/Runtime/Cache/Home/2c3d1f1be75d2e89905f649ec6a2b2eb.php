...
<head>
    ...
    <style type="text/css">
        ...
        *{margin:0; padding:0; list-style:none; }
        ...
        .navBar{  position:relative; z-index:1; padding-left:10px;   height:60px; line-height:60px; background:url(/thinkphp/Public/home/img/line.gif) repeat-x 0 bottom #fff; color:#333;   }
            ...
            <div class="wrapper">
                <div class="navBar">
                    <ul class="nav clearfix">
                        ...
                        <li class="s">|</li>
                        <li class="m">
                            <h3><a href="/thinkphp/home/online/index">在线考试</a></h3>
                        </li>
                        <li class="s">|</li>
                        <li class="m "><!-- 当前频道添加on -->
                            <h3><a href="/thinkphp/home/list/index?pid=3">初 中</a></h3>
                            <ul class="sub">
                                <li><a href="#">语文</a></li>
                                <li><a href="#">数学</a></li>
                                <li><a href="#">英语</a></li>
                        ...
                        <li class="s">|</li>
                        <li class="m">
                            <h3><a href="/thinkphp/home/list/index?pid=4">高 中</a></h3>
                            <ul class="sub">
                                <li><a href="#">语文</a></li>
                                <li><a href="#">数学</a></li>
                                <li><a href="#">英语</a></li>
                        ...
                        <li class="s">|</li>
                        <li class="m">
                            <h3><a href="/thinkphp/home/list/index?pid=5">大 学</a></h3>
                            <ul class="sub">
                                <li><a href="#">高等数学</a></li>
                                <li><a href="#">大学英语</a></li>
                                <li><a href="#">大学物理</a></li>
