                    ...
                    <div class="col-sm-12">
                        <table class="table table-striped table-bordered table-hover  dataTable" id="editable" role="grid" aria-describedby="editable_info">
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="editable" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 142px;">类型</th>
                            ...
                            <tbody>
                                <tr class="gradeA odd" role="row">
                                    ...
                                    <td class="center">
                                        <a href="/thinkphp/admin/questions/edit">修改</a> ||
                                        <a href="/thinkphp/admin/questions/del">删除</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
