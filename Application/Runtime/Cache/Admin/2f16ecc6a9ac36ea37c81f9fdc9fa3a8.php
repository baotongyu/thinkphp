                        ...
                        <table class="table table-striped table-bordered table-hover  dataTable" id="editable" role="grid" aria-describedby="editable_info">
                            ...
                            <tbody>
                                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="gradeA odd" role="row">
                                    ...
                                    <td class="center"><?php if($vo['answer']==1) echo 'A'; elseif($vo['answer']==2) echo 'B'; elseif($vo['answer']==3) echo 'C'; else echo 'D';?></td>
                                    ...
                                    <td class="center">
                                        <a href="/thinkphp/admin/questions/edit1?id=<?php echo ($vo['id']); ?>">修改</a> ||
                                        <a href="/thinkphp/admin/questions/del1?id=<?php echo ($vo['id']); ?>">删除</a>
                                    </td>
