            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li><a href="/thinkphp/admin/questions/add">添加单选题</a></li>
                        <li><a href="/thinkphp/admin/questions/add">添加多选题</a></li>
                        <li><a href="/thinkphp/admin/questions/add">添加判断题</a></li>
                    </ul>
                </li>
                <!--试题管理 结束-->
...
<!--左侧导航栏 结束-->
    ...
    <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div class="ibox-content">
            <form action="/thinkphp/admin/questions/insert" method="post" class="form-horizontal">
                ...
                <div class="form-group"><label class="col-sm-2 control-label">正确答案：</label>
                    <div class="col-sm-10">
                        <div>
                            <label> <input type="radio" value="1" id="optionsRadios1" name="answerA">A</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <label> <input type="radio" value="2" id="optionsRadios2" name="answerB">B</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <label> <input type="radio" value="3" id="optionsRadios3" name="answerC">C</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <label> <input type="radio" value="4" id="optionsRadios4" name="answerD">D</label>
                        </div>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group"><label class="col-sm-2 control-label">难以程度：</label>
