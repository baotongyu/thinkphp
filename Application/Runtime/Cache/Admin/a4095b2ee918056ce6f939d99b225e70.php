...
<!--左侧导航栏 结束-->
    ...
    <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div class="ibox-content">
            <form action="/thinkphp/admin/questions/update1" method="post" class="form-horizontal">
                ...
                <div class="form-group"><label class="col-sm-2 control-label">正确答案：</label>
                    <div class="col-sm-10">
                        <div>
                            <label> <input type="radio" value="1" id="optionsRadios1" name="answer" <?php if($data['answer']==1) echo 'checked';?>>A</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <label> <input type="radio" value="2" id="optionsRadios2" name="answer" <?php if($data['answer']==2) echo 'checked';?>>B</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <label> <input type="radio" value="3" id="optionsRadios3" name="answer" <?php if($data['answer']==3) echo 'checked';?>>C</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <label> <input type="radio" value="4" id="optionsRadios4" name="answer" <?php if($data['answer']==4) echo 'checked';?>>D</label>
                        </div>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
