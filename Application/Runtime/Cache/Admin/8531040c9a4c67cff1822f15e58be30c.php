...
<!--左侧导航栏 结束-->
    ...
    <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div class="ibox-content">
            <form action="/thinkphp/admin/questions/insert2" method="post" class="form-horizontal">
                ...
                <div class="form-group"><label class="col-sm-2 control-label">正确答案：</label>
                    <div class="col-sm-10">
                        <label class="checkbox-inline"><input type="checkbox" value="1" id="inlineCheckbox1" name="answer1"> A </label>
                        <label class="checkbox-inline"><input type="checkbox" value="2" id="inlineCheckbox2" name="answer2"> B </label>
                        <label class="checkbox-inline"><input type="checkbox" value="3" id="inlineCheckbox3" name="answer3"> C </label>
                        <label class="checkbox-inline"><input type="checkbox" value="4" id="inlineCheckbox4" name="answer4"> D </label>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
