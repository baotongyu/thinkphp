...
<!--左侧导航栏 结束-->
    ...
    <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div class="ibox-content">
            <form action="/thinkphp/admin/questions/insert3" method="post" class="form-horizontal">
                ...
                <div class="form-group"><label class="col-sm-2 control-label">正确答案：</label>
                    <div class="col-sm-10">
                        <div>
                            <label> <input type="radio" value="1" id="optionsRadios1" name="answer">对</label> &nbsp;
                            <label> <input type="radio" value="2" id="optionsRadios2" name="answer">错</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
