                    ...
                    <div class="col-sm-12">
                        <table class="table table-striped table-bordered table-hover  dataTable" id="editable" role="grid" aria-describedby="editable_info">
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="editable" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 142px;">选项</th>
                                ...
                                <th class="sorting" tabindex="0" aria-controls="editable" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 142px;">分值</th>
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="gradeA odd" role="row">
                                    ...
                                    <td><?php echo ($vo['answera']); ?>  <?php echo ($vo['answerb']); ?>  <?php echo ($vo['answerc']); ?>  <?php echo ($vo['answerd']); ?></td>
                                    <td class="center"><?php if($vo['answer1']==1) echo 'A'; if($vo['answer2']==2) echo 'B'; if($vo['answer3']==3) echo 'C'; if($vo['answer4']==4) echo 'D';?></td>
                                    ...
                                    <td class="center"><?php echo ($vo['m_score']); ?>分</td>
                                    <td class="center">
                                        <a href="/thinkphp/admin/questions/edit2?id=<?php echo ($vo['id']); ?>">修改</a> ||
                                        <a href="/thinkphp/admin/questions/del2?id=<?php echo ($vo['id']); ?>">删除</a>
                                    </td>
